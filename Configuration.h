...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "REPRAP3D"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -15.45

  #define Z_RAISE_BEFORE_HOMING 15       // (in mm) Raise Z before homing (G28) for Probe Clearance.
                                        // Be sure you have this distance over your Z_MAX_POS in case

  #define XY_TRAVEL_SPEED 9500         // X and Y axis travel speed between probes, in mm/min
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,525.667}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 200, 10, 35}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,1500,25,4000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 110,10} // X,Y,Z Axis Extend and Retract angles
